...
// LOL(e스포츠)은 "3.5 오버" / "31분 오버" / "-1.5 핸디" 등 등록된 베팅옵션 라벨이 워낙 다양해서
// 일반승/핸디캡/세트승 같은 고정 카테고리로는 다 못 담는다 — 그래서 마켓 고정분류 대신
// SportPanel에서 이미 렌더되는 BetOptionStatsSection(등록된 옵션 라벨 하나하나 기준)을 그대로 쓴다.
...
// 배구도 LOL과 마찬가지 — "핸디캡" 하나로 뭉뚱그리지 않고 등록된 옵션 라벨(-2.5, -1.5 등)
// 하나하나의 적중률은 SportPanel에서 렌더되는 BetOptionStatsSection이 담당한다.
